...
console.log(" 5. Modificar usuario campos vacíos");
...
function confirmarUsuario(email,key){
	...
	console.log("---------------------------------------------------------------");
	console.log("3. Confirmar cuenta usuario: "+email+" con key errónea "+key);
	console.log("---------------------------------------------------------------");
...
function iniciarSesion(email,password){
	...
	console.log("-------------------------------------------------------------------");
	console.log("4. El usuario: "+email+" intenta iniciar sesión");
	console.log("-------------------------------------------------------------------");
	...
	request(options,function(error,response,body){
		if (!error && response.statusCode==200){
    		...
    		if (usuario.email!=""){
	    		console.log("Usuario "+usuario.email+" ha iniciado la sesión \n");
